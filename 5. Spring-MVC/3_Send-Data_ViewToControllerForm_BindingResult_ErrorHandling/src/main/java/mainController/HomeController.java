...
*/
    // Model Attribute
    @RequestMapping(path = "/submitMessage", method = RequestMethod.POST)
    public String submitMessageModelAttribute(@ModelAttribute User user, Model model, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            model.addAttribute("messagee", "There is a error. "+bindingResult);
            return "contact";
        }
        welcomeHeader(model);
