...
public class Main {
    public static void main(String[] args) {
        ...
        ApplicationContext context = new ClassPathXmlApplicationContext("_7_LifeCycleSpringMethodAnnotations.xml");
        ...
        AbstractApplicationContext context1 = new ClassPathXmlApplicationContext("_7_LifeCycleSpringMethodAnnotations.xml");
