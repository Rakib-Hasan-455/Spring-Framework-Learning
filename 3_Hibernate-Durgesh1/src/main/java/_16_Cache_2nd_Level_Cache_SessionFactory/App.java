...
public class App {
    public static void main(String[] args) {
        ...
        // 2nd level cache enabled and will be active till session is closed

        SessionFactory sessionFactory = configuration.configure("hibernate16.cfg.xml").buildSessionFactory();
